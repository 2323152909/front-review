...
const p1 = new HDPromise((resolve, reject) => {
    setTimeout(() => {
        reject("p1")
    }, 3000)
})
const p2 = new HDPromise((resolve, reject) => {
    setTimeout(() => {
        reject("p2")
    }, 2000)
})
const p3 = new HDPromise((resolve, reject) => {
    setTimeout(() => {
        reject("p3")
    }, 3000)
})

HDPromise.race([p1, p2, p3]).then(res => {
    console.log("reace res: ", res);
}).catch(err => {
    console.log("race err: ", err);
})

HDPromise.any([p1, p2, p3]).then(res => {
